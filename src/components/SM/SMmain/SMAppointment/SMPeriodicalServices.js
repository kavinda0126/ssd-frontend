...
const SMPeriodicalServices = ({ toggleLoading }) => {
  ...
  function senddataperiodicalAppointmentHistory() {
    ...
    toggleLoading(true); 
    apiService.post(`/appointment/addaceptedperiodicalAppointment`,newacceptedPeriodicalAppointment).then(() => {
  ...
  useEffect(() => {
    ...
    function getPeriodicalAppointment() {
      ...
      apiService.get(`/appointment/get-periodicalAppointment`).then((res) => {
