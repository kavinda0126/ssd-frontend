...
const SMMechanicalRepairs = ({ toggleLoading }) => {
  ...
  function senddatamechanicalAppointmentHistory() {
    ...
    apiService.post(`/appointment/addacceptedmechanicalAppointment`, newacceptedmechanicalAppointment).then(() => {
  ...
  useEffect(() => {
    ...
    function getmechanicalAppointment() {
      ...
      apiService.get(`/appointment/get-mechanicalAppointment`).then((res) => {
