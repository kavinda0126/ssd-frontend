...
const SMAccidentalRepairs = ({ toggleLoading }) => {
  ...
  function sendata(e) {
    ...
    toggleLoading(true);
    apiService.post(`/appointment/addacceptedappointment`,newacceptedappointment).then(() => {
  ...
  function senddataAccidentalAppointmentHistory() {
    ...
    toggleLoading(true); 
    apiService.post(`/appointment/addacceptedaccidentalAppointment`,newacceptedaccidentalAppointment).then(() => {
  ...
  useEffect(() => {
    ...
    function getaccidentalAppointment() {
      toggleLoading(true); 
      apiService.get(`/appointment/get-accidentalAppointment`).then((res) => {
  ...
  const Delete = (id) => {
    toggleLoading(true);
      apiService.delete(`/appointment/delete-accidentalAppointment/${id}`)
        .then(response => {
  ...
  const cancleAppointment = (id,Image) => {
    const image = Image;
    apiService.delete(`/appointment/delete-allwithimage/${id}`,{data:{image}})
      .then(response => {
        window.location.reload();
      }).catch(error => {
        // Handle errors here
