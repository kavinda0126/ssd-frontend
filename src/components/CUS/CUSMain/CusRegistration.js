...
const handleConfirmPasswordChange = (e) => {
  ...
  function sendCusDetails(e){
    ...
    // Use CSRF-protected API service for registration
    apiService.register("/api/customer/signup/add-customer", newCustomer)
      .then(data => {
    ...
    return(
        ...
        <Button variant="light" onClick={() => setConfirmShowPassword(!showConfirmPassword)} className="toggle-password-button">
            {showConfirmPassword ? <BsEyeSlash /> : <BsEye />}
                ...
                <div className="form-check">
                 <input className="form-check-input" type="checkbox" value="" id="flexCheckDefault"/>
                  <label className="form-check-label" htmlFor="flexCheckDefault" required>
                  I agree to all <a href="#" className="link-info"> Terms & Conditions</a>
                  </label>
                </div>  
            ...
            <Button 
              ...
              style={{marginLeft:"30px", width:"90%", border: "1px solid #ccc"}}
              onClick={() => window.location.href = `${process.env.React_App_Backend_URL}/api/customer/auth/google`}
            >
              <FcGoogle size={20} />
            ...
            <a href={cuslogin_frontendurl} className="link-info"> Sign in</a></center></p>
            </Card.Body>
             </Card>
              </Form>
              </Col>
            ...
            <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel" 
              ...
              <div className="carousel-inner">
               <div className="carousel-item active" data-bs-interval="10000">
                <img src={cusimage2} className="d-block w-300" alt="..."/>
               </div>
               <div className="carousel-item" data-bs-interval="2000">
                <img src={cusimage1} className="d-block w-300" alt="..."/>
               </div>
               <div className="carousel-item">
                <img src={cusimage3} className="d-block w-300" alt="..."/>
               </div>
              </div>
