  ...
  const handleUploadPDF = async () => {
    ...
    try {
      ...
      const response = await apiService.uploadFile(
        `/api/finance/billing/uploadinvoice`,
        formData
      );
      ...
      const dbResponse = await apiService.post(
        `/api/finance/invoices/addonline`,
        postData
      );
      ...
      const incomeResponse = await apiService.post(
        `/api/finance/incomes/add-income`,
        incomeData
      );
      ...
      const PHResponse = await apiService.post(
        `/api/finance/paymenthistory/add`,
        paymentHistoryData
      );
      ...
      // Send a request to the backend controller for sending email
      await apiService.post(`/api/finance/email`, {
        to: emailOptions.to,
