...
function CusLogin({ toggleLoading }){
  ...
  function CustomerLogin(e){
    ...
    try{
      ...
      // Use CSRF-protected API service for login
      apiService.login("/api/customer/cus-login", loginCustomer)
        .then(data => {
        ...
        <main id="main" style={{marginLeft:"20px",marginTop:"1px"}}>
         <Card>
           ...
           <Container>
            ...
            <Button 
                variant="light" 
                style={{marginTop:"10px",marginLeft:"30px", width:"90%", border: "1px solid #ccc"}} 
